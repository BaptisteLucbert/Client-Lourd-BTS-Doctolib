...
public class PanelMedecins extends PanelPrincipal implements ActionListener, KeyListener {
    ...
    private JTextField txtNom, txtPrenom, txtTel, txtMail, txtFaculte;
    ...
    private JPanel createMedecinInfoPanel() {
        ...
        JLabel lblFaculte = new JLabel("Faculté : ");
        gbc.gridx = 0;
        gbc.gridy = 5;
        panel.add(lblFaculte, gbc);

        txtFaculte = new JTextField(20);
        gbc.gridx = 1;
        gbc.gridy = 5;
        panel.add(txtFaculte, gbc);
    ...
    private JPanel createTablePanel() { 
        ...
        // Ajout d'un tableau
        String entetes [] = {"ID", "Nom", "Prénom", "Email", "Téléphone", "Spécialité", "Faculté"};
    ...
    public Object [][] obtenirDonnees (String filtre){
		...
		Object [][] matrice = new Object[lesMedecins.size()][7];
		int i = 0; 
