...
public class PanelPrescriptions extends PanelPrincipal implements ActionListener, KeyListener {
    ...
    private JPanel createPrescriptionInfoPanel() {
        ...
        gbc.gridx = 0;
        gbc.gridy = 5;
        panel.add(new JLabel("Prise de médicament : "), gbc);
        gbc.gridx = 1;
        gbc.gridy = 5;
        gbc.fill = GridBagConstraints.HORIZONTAL;
    ...
    private JPanel createTablePanel() {
        ...
        // Ajout d'un tableau
        String entetes[] = {"ID", "Date", "Médicament", "Patient", "Médecin", "Prise de médicament"};
		...
		this.tablePrescription.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (e.getClickCount()>=2) {
                    ...
                    String priseMedicament = tablePrescription.getValueAt(numLigne, 5).toString();
    ...
    private Object[][] obtenirDonnees(String filtre) {
        ...
        Object [][] matrice = new Object[lesPrescriptions.size()][6];
		int i = 0; 
		for (Prescription unePrescription : lesPrescriptions) {
            matrice[i][0] = unePrescription.getIdprescription();
            matrice[i][1] = unePrescription.getDateprescription();
            matrice[i][2] = unePrescription.getMedicament();
            matrice[i][3] = unePrescription.getIdpatient();
            matrice[i][4] = unePrescription.getIdmedecin();
            matrice[i][5] = unePrescription.getPriseMedicament();
			i++;
		}
		return matrice;
    }
