    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource()==this.btAnnuler) {
            ...
            if (nom.equals("") || prenom.equals("") || email.equals("") || tel.equals("") || mdp.equals("")) {
                ...
                ok = false;
            } // Controler le numéro de téléphone si il commence par 0 et a 10 chiffres et changer le fond en rouge si c'est faux
            else if (!Pattern.matches("0[1-9][0-9]{8}", tel)) {
