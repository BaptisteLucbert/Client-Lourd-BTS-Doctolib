...
public class Controleur {
    ...
    public static void ajouterPatient(String nom, String prenom, String adresse, String codePostal, String ville, String telephone, String email, String dateNaissance, String sexe, int idmedecin) {
        Modele.ajouterPatient(nom, prenom, adresse, codePostal, ville, telephone, email, dateNaissance, sexe, idmedecin);
    }

    public static Patient selectWherePatient(String nom, String prenom, String adresse, String ville, String telephone, String email, String dateNaissance, String codePostal, String sexe) {
    ...
    public static Prescription selectWherePrescription(String dateprescription, String medicament, int idpatient, int idmedecin, String priseMedicament) {
        return Modele.selectWherePrescription(dateprescription, medicament, idpatient, idmedecin, priseMedicament);
    }
